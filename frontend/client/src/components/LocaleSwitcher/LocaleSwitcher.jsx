  ...
  return (
    ...
    >
      <div className="relative">
        <Listbox.Button className="relative flex items-center border-slate-300 bg-white py-2 pr-10 pl-3 border rounded-lg w-full text-gray-600 text-left cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-white/75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm">
