...
import { useThemeProvider } from "../../utils/dashboard/ThemeContext";
...
// Import utilities
import { tailwindConfig, formatValue } from "../../utils/dashboard/Utils";
    ...
    <React.Fragment>
      <div className="px-5 py-3">
        <div className="flex items-start">
          <div className="mr-2 font-bold text-3xl text-slate-800 dark:text-slate-100 tabular-nums">
            $<span ref={chartValue}>57.81</span>
          </div>
          <div
            ref={chartDeviation}
            className="px-1.5 rounded-full font-semibold text-sm text-white"
          ></div>
        </div>
      </div>
      <div className="grow">
