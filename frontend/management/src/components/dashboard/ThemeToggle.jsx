...
export default function ThemeToggle() {
  ...
  return (
    <div>
      ...
      />
      <label
        className="flex justify-center items-center bg-slate-100 hover:bg-slate-200 dark:hover:bg-slate-600/80 dark:bg-slate-700 rounded-full w-8 h-8 cursor-pointer"
