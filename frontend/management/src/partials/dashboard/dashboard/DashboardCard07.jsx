...
function DashboardCard07() {
  return (
    <div className="border-slate-200 dark:border-slate-700 col-span-full xl:col-span-8 bg-white dark:bg-slate-800 shadow-lg border rounded-sm">
      ...
      <div className="p-3">
        ...
        <div className="overflow-x-auto">
          <table className="w-full dark:text-slate-300 table-auto">
            {/* Table header */}
            <thead className="bg-slate-50 dark:bg-slate-700 dark:bg-opacity-50 rounded-sm text-slate-400 text-xs dark:text-slate-500 uppercase">
              <tr>
                <th className="p-2">
