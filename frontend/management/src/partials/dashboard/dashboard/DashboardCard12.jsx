      ...
      <div className="p-3">
        ...
        <div>
          ...
          <ul className="my-1">
            ...
            <li className="flex px-2">
              <div className="bg-indigo-500 my-2 mr-3 rounded-full w-9 h-9 shrink-0">
                <svg
                ...
                <div className="flex justify-between grow">
                  ...
                  <div className="ml-2 self-end shrink-0">
                    <a
                      ...
                      href="#0"
                    >
                      View<span className="sm:inline hidden"> -&gt;</span>
                    </a>
                  </div>
                </div>
              </div>
        ...
        <div>
          ...
          <ul className="my-1">
            {/* Item */}
            <li className="flex px-2">
              <div className="bg-sky-500 my-2 mr-3 rounded-full w-9 h-9 shrink-0">
                <svg
